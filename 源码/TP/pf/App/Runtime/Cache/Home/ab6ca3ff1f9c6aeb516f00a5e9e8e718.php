...
<head>
    ...
    <!-- Link Swiper's CSS -->
    <link rel="stylesheet" href="/TP/pf/Public/qt/template/template4/css/swiper.min.css" type="text/css">
	...
	.swiper_con ul li{width:30%;float:left;
		text-align:center;
		margin-left:2.5%;
		margin-top:8px;
        display: -webkit-box;
	...
	.swiper_con ul li span{display:block;color:#4e4e4e;}
	...
	.add_box ul li{padding:8px 0 8px 20px;background:#fff;;background-size:14px 14px;padding-left:20px;font-size:14px;color:#4e4e4e;margin-top:5px;border-radius:3px;}
    </style>
</head>
<body>
    <!-- Swiper -->
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <?php if(isset($slideshowlist[0][title])): ?><div class="swiper-slide"><a href="<?php echo ($slideshowlist["1"]["url"]); ?>"><img src="/TP/pf/Public<?php echo ($slideshowlist["1"]["pic"]); ?>"></a><p><?php echo ($slideshowlist["1"]["title"]); ?></p></div><?php endif; ?>

            <?php if(isset($slideshowlist[0][title])): ?><div class="swiper-slide"><a href="<?php echo ($slideshowlist["2"]["url"]); ?>"><img src="/TP/pf/Public<?php echo ($slideshowlist["2"]["pic"]); ?>"></a><p><?php echo ($slideshowlist["2"]["title"]); ?></p></div><?php endif; ?>

            <?php if(isset($slideshowlist[0][title])): ?><div class="swiper-slide"><a href="<?php echo ($slideshowlist["3"]["url"]); ?>"><img src="/TP/pf/Public<?php echo ($slideshowlist["3"]["pic"]); ?>"></a><p><?php echo ($slideshowlist["3"]["title"]); ?></p></div><?php endif; ?>
        </div>
        <!-- Add Pagination -->
    	...
    	<ul class="cf">
            ...
            <?php if(isset($buttonlist[0][title])): ?><li>
            	<a href="<?php echo ($buttonlist["0"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg1.png">
            ...
            <?php if(isset($buttonlist[1][title])): ?><li>
            	<a href="<?php echo ($buttonlist["1"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg2.png">
            ...
            <?php if(isset($buttonlist[2][title])): ?><li>
            	<a href="<?php echo ($buttonlist["2"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg3.png">
            ...
            <?php if(isset($buttonlist[3][title])): ?><li>
            	<a href="<?php echo ($buttonlist["3"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg4.png">
            ...
            <?php if(isset($buttonlist[4][title])): ?><li>
            	<a href="<?php echo ($buttonlist["4"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg5.png">
            ...
            <?php if(isset($buttonlist[5][title])): ?><li>
            	<a href="<?php echo ($buttonlist["5"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/lisimg6.png">
            ...
            <?php if(isset($buttonlist[6][title])): ?><li>
            	<a href="<?php echo ($buttonlist["6"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/wm.png">
            ...
            <?php if(isset($buttonlist[7][title])): ?><li>
            	<a href="<?php echo ($buttonlist["7"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/cz.png">
                    <span><?php echo ($buttonlist["7"]["title"]); ?></span>
                </a>
            </li><?php endif; ?>
            <?php if(isset($buttonlist[8][title])): ?><li>
            	<a href="<?php echo ($buttonlist["8"]["url"]); ?>">
                	<img src="/TP/pf/Public/qt/template/template4/images/dj.png">
    ...
    <!-- Swiper JS -->
    <script src="/TP/pf/Public/qt/template/template4/js/swiper.min.js"></script>
