...
<head>
    ...
    <!-- Link Swiper's CSS -->
    <link rel="stylesheet" href="/TP/pf/Public/qt/template/template3/css/swiper.min.css" type="text/css">
	...
	.add_box ul li{padding:5px 0 5px 20px; border-bottom:1px solid #ddd;background:url(/TP/pf/Public/qt/template/template3/images/bg_icon.png) no-repeat left 8px;background-size:14px 14px;padding-left:20px;font-size:14px;color:#fff;}
    </style>
</head>
<body>
    <!-- Swiper -->
    ...
    <!-- Swiper JS -->
    <script src="/TP/pf/Public/qt/template/template3/js/swiper.min.js"></script>
