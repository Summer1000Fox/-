                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<form action="<?php echo U('editslideshow?adminid='.$_SESSION['xql']['resource']['resourceadminid']);?>" method="post" enctype="multipart/form-data">
                            <?php if(is_array($slideshowlist)): foreach($slideshowlist as $key=>$slideshowlistval): ?><table class="table table-striped table-bordered table-hover">
							<input type="hidden" name="rid" value="<?php echo ($slideshowlistval["rid"]); ?>">

								<tr>
									<td>标题</td>
									<td><input type="text" name='title'  value="<?php echo ($slideshowlistval["title"]); ?>" class="form-control"></td>
								</tr>
								<tr>
                                    <td>URL</td>
                                    <td><input type="text" name='url'  value="<?php echo ($slideshowlistval["url"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>轮播图图片</td>
                                    <td><input type="file" name='pic' class="form-control"><a href="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>"><img width="240px" height="100px" src="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>" alt="<?php echo ($slideshowlistval["title"]); ?>"></a></td>
                                </tr>
                                <tr>
                                    <td>优先级</td>
                                    <td><input type="text" name='priority'  value="<?php echo ($slideshowlistval["priority"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
