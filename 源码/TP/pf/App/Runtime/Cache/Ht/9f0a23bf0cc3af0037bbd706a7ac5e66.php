                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo U('oinfochange');?>" method="post" enctype="multipart/form-data">
                            
                            <table class="table table-striped table-bordered table-hover">  
                            <?php if(is_array($oinfolist)): foreach($oinfolist as $key=>$oinfolistval): ?><input type="hidden" name="id" value="<?php echo ($oinfolistval["id"]); ?>">
                                <tr>
                                    <td>机构名称</td>
                                    <td><input type="text" readonly="readonly"  name='oname' value="<?php echo ($oinfolistval["oname"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>机构编号</td>
                                    <td><input type="text" readonly="readonly"  name='onum' value="<?php echo ($oinfolistval["onum"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>城市地区</td>
                                    <td><input type="text" readonly="readonly" name='place' value="<?php echo ($oinfolistval["place"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>固定电话</td>
                                    <td><input type="text" name='phone' value="<?php echo ($oinfolistval["phone"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>地址</td>
                                    <td><input type="text" name='address' value="<?php echo ($oinfolistval["address"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>邮政编码</td>
                                    <td><input type="text" name='postalcode' value="<?php echo ($oinfolistval["postalcode"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
