                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<form action="<?php echo U('addarticle');?>" method="post" enctype="multipart/form-data">
							<table class="table table-striped table-bordered table-hover">							
								<tr>
                                    <td width="150px">文章标题</td>
								...
								<tr>
									<td>优先级</td>
									<td><input type="input" name='priority' class="form-control"><br>省级管理员:1-10;支行管理员11-20;网点管理员21-99;</td>
								</tr>
                                <tr>
                                    <td>内容</td>
                                    <td width="90%">
