...
.login_box .center{text-align:left;position:relative;_width:360px;min-width:360px;max-width:360px;padding:0 0 0 484px;background:url(/TP/pf/Public/ht/images/logo.png) no-repeat left 50px;}
