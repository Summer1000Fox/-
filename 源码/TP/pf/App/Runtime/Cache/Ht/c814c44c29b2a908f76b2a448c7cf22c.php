...
<body>
    ...
    <div id="wrapper"> 
        ...
        <!-- Navigation -->
		<form id="form_search" method="post" action="<?php echo U(selectresource);?>">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo ($selectinfo); ?><p>如果资源不够,请添加资源并及时联系上级审核.</p></h1>
            ...
            <div class="row">
                <div class="col-lg-12">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<?php if(!empty($slideshowlist)): if(is_array($slideshowlist)): foreach($slideshowlist as $key=>$slideshowlistval): ?><tr>
												<td><input type="checkbox" name="rids[]" value="<?php echo ($slideshowlistval["rid"]); ?>"  class="form-control"/></td>
												<td><?php echo ($slideshowlistval["rid"]); ?></td>
												<td><?php echo ($slideshowlistval["title"]); ?></td>
												<td><a href="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>"><img width="120px" height="50px" src="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>" alt="<?php echo ($buttonlistvalpic["pic"]); ?>"></a></td>
												<td><?php echo ($slideshowlistval["adminid"]); ?></td>
												<td><?php echo ($slideshowlistval["priority"]); ?></td>
												<td><?php echo ($slideshowlistval["rcode"]); ?></td>
												<td><a href="http://<?php echo ($slideshowlistval["url"]); ?>"><?php echo ($slideshowlistval["url"]); ?></a></td>
					...
					<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<?php if(!empty($buttonlist)): if(is_array($buttonlist)): foreach($buttonlist as $key=>$buttonlistval): ?><tr>
									<td><input type="checkbox" name="ridb[]" value="<?php echo ($buttonlistval["rid"]); ?>"  class="form-control"/></td>
									<td><?php echo ($buttonlistval["rid"]); ?></td>
									<td><?php echo ($buttonlistval["title"]); ?></td>
									<td><?php echo ($buttonlistval["adminid"]); ?></td>
									<td><?php echo ($buttonlistval["priority"]); ?></td>
									<td><?php echo ($buttonlistval["rcode"]); ?></td>
									<td>
										<a href="http://<?php echo ($buttonlistval["url"]); ?>"><?php echo ($buttonlistval["url"]); ?></a>
									</td>
								</tr><?php endforeach; endif; ?>
								<?php else: ?>
								<tr>
                    ...
                    <input type="submit" value="创建微站" class="btn btn-primary" />
                    <!-- /.panel -->
                </div>
                <!-- /.col-lg-12 -->
            </div>
