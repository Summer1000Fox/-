                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<?php if(!empty($officelist)): if(is_array($officelist)): foreach($officelist as $key=>$officelistval): ?><tr>
									<td><?php echo ($officelistval["id"]); ?></td>
									<td><?php echo ($officelistval["onum"]); ?></td>
									<td><?php echo ($officelistval["mcode"]); ?></td>
									<td><?php echo ($officelistval["zhihang"]); ?></td>
									<td><?php echo ($officelistval["place"]); ?></td>
									<td width="20%"><?php echo ($officelistval["oname"]); ?></td>
									<td><?php echo ($officelistval["phone"]); ?></td>
									<td><?php echo ($officelistval["address"]); ?></td>
									<td><?php echo ($officelistval["postalcode"]); ?></td>
									<!-- <td><?php echo (date('Y-m-d H:i:s',$officelistval["atime"])); ?></td> -->
									<td width="15%">
										<?php if($officelistval["wid"] != NULL ): ?><!-- <a href="<?php echo U('createwebsite',array('id'=>$officelistval[id]));?>" >[修改微站]</a> -->
											[已创建微站]
										<?php else: ?> 
											<a href="<?php echo U('createwebsite',array('id'=>$officelistval[id]));?>" >[创建微站]</a><?php endif; ?>
										...
										<a href="<?php echo U('editinfo',array('id'=>$officelistval[id]));?>" >[修改信息]</a>
									</td>
