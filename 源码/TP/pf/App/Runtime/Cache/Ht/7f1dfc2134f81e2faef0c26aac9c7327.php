                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<table class="table table-striped table-bordered table-hover">	
								<tr>
									<td>标题</td>
									<td><?php echo ($seearticlelist["title"]); ?></td>
								</tr>
                                <tr>
                                    <td>作者</td>
                                    <td><?php echo ($seearticlelist["aname"]); ?></td>
                                </tr>
								<tr>
                                    <td>时间</td>
                                    <td><?php echo (date('Y年m月d日 H:i:s',$seearticlelist["addtime"])); ?></td>
                                </tr>
                                    
                                </tr>
                                    <td>点击量</td>
                                    <td><?php echo ($seearticlelist["hits"]); ?></td>
                                </tr>
                                <tr>
                                    <td>封面图片</td>
                                    <td><a href="/TP/pf/Public<?php echo ($seearticlelist["pic"]); ?>"><img width="240px" height="100px" src="/TP/pf/Public<?php echo ($seearticlelist["pic"]); ?>" alt="<?php echo ($seearticlelist["pic"]); ?>"></a></td>
                                </tr>
                                <tr>
                                    <td>内容</td>
                                    <td><?php echo ($seearticlelist["content"]); ?></td>
                                </tr>
							</table>
							</form>
							</div>
