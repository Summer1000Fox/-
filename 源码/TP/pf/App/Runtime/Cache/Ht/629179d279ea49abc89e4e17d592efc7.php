...
<body>
    ...
    <div id="wrapper"> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">网点csv</h1>
                    <a href="<?php echo U('officecsv?action=export');?>">导出CSV</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<form action="<?php echo U('officecsv?action=import');?>" method="post" enctype="multipart/form-data">
							<table class="table table-striped table-bordered table-hover">							
								...
								<tr>
									<td colspan="2" align="center">
										<input type="submit" value="导入csv" class="btn btn-primary">
                                        <input type="button" class="btn btn-primary" value="导出CSV" onclick="window.location.href=<?php echo U('officecsv?action=export');?>">
									</td>
								</tr>
							</table>
							</form>
