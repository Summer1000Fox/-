...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" charset="utf-8" src="/TP/pf/Public/ht/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/TP/pf/Public/ht/ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="/TP/pf/Public/ht/ueditor/lang/zh-cn/zh-cn.js"></script>
...
<body>
    ...
    <div id="wrapper"> 
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">建设银行个人金融管理系统</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<form action="<?php echo U('editarticle?adminid='.$_SESSION['xql']['resource']['resourceadminid']);?>" method="post" enctype="multipart/form-data">
                            <?php if(is_array($articlelist)): foreach($articlelist as $key=>$articlelistval): ?><table class="table table-striped table-bordered table-hover">
							<input type="hidden" name="rid" value="<?php echo ($articlelistval["rid"]); ?>">

								<tr>
									<td>标题</td>
									<td><input type="text" name='title'  value="<?php echo ($articlelistval["title"]); ?>" class="form-control"></td>
								</tr>
								<tr>
                                    <td>URL</td>
                                    <td><input type="text" name='url'  value="<?php echo ($articlelistval["url"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>封面图片</td>
                                    <td><input type="file" name='pic' class="form-control"><a href="/TP/pf/Public<?php echo ($articlelistval["pic"]); ?>"><img width="240px" height="100px" src="/TP/pf/Public<?php echo ($articlelistval["pic"]); ?>" alt="<?php echo ($articlelistval["title"]); ?>"></a></td>
                                </tr>
                                <tr>
                                    <td>优先级</td>
                                    <td><input type="text" name='priority'  value="<?php echo ($articlelistval["priority"]); ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>内容</td>
                                    <td width="90%">
                                        <script id="editor" type="text/plain"  name="content" style="height:500px;"><?php echo ($articlelistval["content"]); ?></script>
