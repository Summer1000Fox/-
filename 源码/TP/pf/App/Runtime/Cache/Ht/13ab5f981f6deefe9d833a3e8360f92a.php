...
<body>
    ...
    <div id="wrapper"> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">审批下级的文章</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<?php if(is_array($articlelist)): foreach($articlelist as $key=>$articlelistval): ?><table class="table table-striped table-bordered table-hover">	
                                ...
                                <tr>
                                    <td>发布人</td>
                                    <td><?php echo ($articlelistval["aname"]); ?></td>
                                </tr>
                                ...
                                <tr>
									<td colspan="2" align="center">
										<input onclick="document.linkform.act.value='pass'; document.linkform.submit();" name="<?php echo U('auditarticle');?>" type="button" value="通过审核" />
