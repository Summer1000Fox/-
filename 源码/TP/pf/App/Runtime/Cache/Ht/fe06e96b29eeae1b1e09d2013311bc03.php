...
<body>
    ...
    <div id="wrapper"> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">审批下级的轮播图</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<?php if(is_array($slideshowlist)): foreach($slideshowlist as $key=>$slideshowlistval): ?><table class="table table-striped table-bordered table-hover">	
                                ...
                                <tr>
                                    <td>发布人</td>
                                    <td><?php echo ($slideshowlistval["aname"]); ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td>图片</td>
                                    <td><a href="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>"><img width="240px" height="100px" src="/TP/pf/Public<?php echo ($slideshowlistval["pic"]); ?>" alt="<?php echo ($slideshowlistvalpic["pic"]); ?>"></a></td>
                                </tr>
                                <tr>
                                    <td>优先级</td>
                                ...
                                <tr>
									<td colspan="2" align="center">
										<input onclick="document.linkform.act.value='pass'; document.linkform.submit();" name="<?php echo U('auditslideshow');?>" type="button" value="通过审核" />
