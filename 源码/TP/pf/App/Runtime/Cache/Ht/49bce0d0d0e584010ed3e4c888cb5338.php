                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            按钮列表 : 筛选出符合条件的<?php echo ($buttoncount); ?>条记录
                        </div>
                        <div class="panel-body">
                        	<div class="well">
								<div class="head"><span>搜索按钮</span></div>
								<div class="main">
									<form id="form_search" method="get" action="<?php echo U(button);?>">
										<table class="table">
											<tr>
												<td>
							...
							<table class="table table-striped table-bordered table-hover">
								<tr>
									<td colspan="16">
										<a href="<?php echo U(addbutton);?>">[添加按钮]</a>
								...
								<?php if(!empty($buttonlist)): if(is_array($buttonlist)): foreach($buttonlist as $key=>$buttonlistval): ?><tr>
									...
									<td><a href="/TP/pf/Public<?php echo ($buttonlistval["pic"]); ?>"><img width="40px" height="40px" src="/TP/pf/Public<?php echo ($buttonlistval["pic"]); ?>" alt="<?php echo ($buttonlistvalpic["pic"]); ?>"></a></td>
									...
									<td>
										<a href="<?php echo U('editbutton',array('id'=>$buttonlistval[rid],'adminid'=>$buttonlistval[adminid]));?>" >[修改]</a><br>
										<a href="<?php echo U('pushresource',array('resourceid'=>$buttonlistval[rid],'adminid'=>$buttonlistval['adminid'],'isaudit'=>$buttonlistval['isaudit']));?>" >[推送]</a><br>
										<a href="<?php echo U('delbutton',array('id'=>$buttonlistval[rid]));?>"  onclick="if(confirm('你确定要删除数据吗？')){ return true;}return false; ">[删除]</a><br>
										<?php if($buttonlistval["isaudit"] == 1 ): ?>[已过审核]
										<?php else: ?> 
											<a href="<?php echo U('auditbutton',array( 'id'=>$buttonlistval[rid], 'rcode'=>$buttonlistval[rcode] ));?>" >[去审核]</a><?php endif; ?>
